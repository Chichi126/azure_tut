...
sas_token = "sv=2022-11-02&ss=bfqt&srt=co&sp=rwdlacupyx&se=2024-08-12T17:51:25Z&st=2024-08-12T09:51:25Z&spr=https&sig=KgGguJvHNksNFd0ZMUlWUAnmn3pLhp65zRj6JD1kC78%3D"
...
try:
    ...
    service_client = get_service_client_sas("chistoragedec", sas_token=sas_token)
...
try:
    ...
    file_system_client = create_file_system(service_client=service_client, file_system_name="chinewstrg")
...
try:
    ...
    file_name = "Global_EV_Data_2024.csv"  
